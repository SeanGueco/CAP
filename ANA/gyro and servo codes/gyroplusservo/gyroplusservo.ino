...
void setup() {
    ...
    mpu.initialize();
    myservo.attach(9);
    myservo.write(90); // Set initial position of the servo
}
...
void loop() {
    ...
    // Use gyroscope readings to adjust the servo position
    int servoOffset = map(gy, -32768, 32767, -20, 20); // Adjust the mapping range as needed
    val += servoOffset;

    // Ensure the servo angle stays within the valid range
